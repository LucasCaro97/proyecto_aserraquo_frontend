...
export const IngresosTable = ({ onEdit, onView }) => {
    ...
    const cargarTodosLosIngresos = async () => {
        ...
        try {
            const response = await axios.get(`${apiUrl}/ingreso`);
    ...
    const datosFiltrados = useMemo(() => {
        ...
        // Aplicar filtro de tipo de ingreso
        if (filtroTipoIngreso) {
            datosFiltrados = datosFiltrados.filter(ingreso =>
                ingreso.tipoIngreso?.nombre === filtroTipoIngreso
            );
        }
    ...
    }, [todosLosIngresos, filtroFechaDesde, filtroFechaHasta, filtroTipoIngreso, filtroUsuario, busquedaObservacion]);
        ...
        return datosParaOrdenar.sort((a, b) => {
            ...
            switch (ordenarPor) {
                ...
                case 'monto':
                    ...
                    break;
                case 'tipoIngreso':
                    valorA = a.tipoIngreso?.nombre || '';
                    valorB = b.tipoIngreso?.nombre || '';
                    break;
                case 'usuario':
    ...
    useEffect(() => {
        setPaginaActual(1);
    }, [filtroFechaDesde, filtroFechaHasta, filtroTipoIngreso, filtroUsuario, busquedaObservacion]);
    ...
    const exportarDatos = () => {
        try {
            ...
            const csvContent = "data:text/csv;charset=utf-8," + 
                "Fecha,Día,Monto,Tipo de Ingreso,Usuario,Observación\n" +
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Gestión de ingresos registrados</p>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-lg font-semibold text-gray-900">Registros de Ingresos</h2>
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center py-12">
                            <CornerDownLeft className="h-12 w-12 mx-auto text-gray-300 mb-4" />
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th 
                                                className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100"
                                                onClick={() => handleOrdenar('tipoIngreso')}
                                            >
                                                <div className="flex items-center space-x-1">
                                                    <span>Tipo</span>
                                                    {renderIconoOrden('tipoIngreso')}
                                                </div>
                                            </th>
                                            <th 
                                                className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100"
