...
export const IngresosFuturosTable = ({ onEdit, onView }) => {
    ...
    // Función para cargar todos los ingresos futuros (sin filtros ni paginación)
    const cargarTodosLosIngresos = async () => {
        ...
        try {
            ...
            setError('Error al cargar los registros de ingresos futuros');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const datosFilterdos = useMemo(() => {
        let datosFiltrados = [...todosLosIngresos];
    ...
    }, [todosLosIngresos, filtroFechaDesde, filtroFechaHasta, filtroUsuario, busquedaObservacion]);
        ...
        return datosParaOrdenar.sort((a, b) => {
            ...
            switch (ordenarPor) {
                case 'fecha':
                    ...
                    break;
                case 'paquetesDespachados':
                    valorA = a.paquetesDespachados;
                    valorB = b.paquetesDespachados;
                    break;
                case 'camionesDespachados':
                    valorA = a.camionesDespachados;
                    valorB = b.camionesDespachados;
                    break;
                case 'ventasTotales':
                    valorA = a.ventasTotales;
                    valorB = b.ventasTotales;
                    break;
                case 'usuario':
    ...
    }, [datosFilterdos, ordenarPor, tipoOrden]);
    ...
    useEffect(() => {
        setPaginaActual(1);
    }, [filtroFechaDesde, filtroFechaHasta, filtroUsuario, busquedaObservacion]);
    ...
    // Función para exportar datos (usa datos filtrados, no paginados)
    const exportarDatos = () => {
        try {
            ...
            const csvContent = "data:text/csv;charset=utf-8," + 
                ...
                datosParaExportar.map(ingreso => 
                    ...
                    `${ingreso.ventasTotales},` +
                    `${ingreso.usuario?.nombre || 'N/A'},` +
                    `"${ingreso.observacion || ''}"`
                ).join("\n");
            ...
            link.setAttribute("download", `ingresos_futuros_${new Date().toISOString().split('T')[0]}.csv`);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Ingresos Futuros</h1>
                            <p className="text-gray-600 mt-1">Gestión de proyecciones de despachos y ventas futuras</p>
                        </div>
                        <div className="flex items-center space-x-3">
                            ...
                            <button
                                onClick={cargarTodosLosIngresos}
                                disabled={isLoading}
                    ...
                    <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <h2 className="text-lg font-semibold text-gray-900">Registros de Ingresos Futuros</h2>
                                        ...
                                        {datosPaginados.map((ingreso, index) => (
                                            <tr key={ingreso.id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    <div className="text-xs text-gray-500">camiones</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
